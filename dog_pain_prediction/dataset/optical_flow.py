...
class Flow_image_builder:
    def __init__(
        self,
        save_file,
        split_path = r"D:\Uni\Thesis\data\annotation\split",
        crop_path = r"D:\Uni\Thesis\data\crop_img",
        kp_path = r"D:\Uni\Thesis\data\annotation\kp_valid", 
...
if __name__ =="__main__":
    data_model = Flow_image_builder(r"D:\Uni\Thesis\data\annotation\optical_flow")
    data_model.pipeline()